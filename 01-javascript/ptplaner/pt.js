...
var optionBox1 = document.getElementsById("origin station");
var optionBox2 = document.getElementsById("destination station");
var firstOptionBox = optionBox1[0];
var secondOptionBox = optionBox2[0];
var ptResult = function (){
   document.write(route);
} 
var submitButton = document.getElementsByTagName('button');
submitButton.addEventListener('click',ptResult);
...
var sliceOutput = sinLine.stations.slice(o,d+1).join(' , ');
var journeyS = 'This journey has ' + sliceOutput.length +' stops. stops on ' + sliceOutput;
return journeyS;
}
...
var totalStops = oriStops.length + desStops.length;
var journeyD = 'This journey has ' + totalStops +' stops. stops on ' + oriStops.join(' , ') + ' , ' + desStops.join(' , ');
return journeyD;
}
